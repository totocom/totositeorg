...
export const siteObservationDescriptionSystemPrompt = [
  ...
  "sites.description에 저장할 짧고 자연스러운 사이트 설명문만 작성합니다.",
  "추천, 홍보, 가입 유도, 입금 유도, 충전 유도, 베팅 유도, 이벤트 강조를 하지 않습니다.",
  "detail_description_md의 첫 문단에는 '이 설명은 조회 시점 기준 관리자가 제공한 공개 HTML과 스크린샷을 바탕으로 작성되었습니다. 화면에 표시된 정보만 요약한 것이며, 가입이나 이용을 권유하는 내용은 아닙니다.' 고지를 넣습니다.",
  "detail_description_md는 3~4문단, 각 문단 2~3문장 이내, 전체 400~700자 정도로 작성합니다.",
  "제목, bullet 목록, 표, 키워드 나열, 원본 URL 직접 표시는 사용하지 않습니다.",
  "원본 HTML의 긴 문장을 그대로 복사하지 말고, 세부 메뉴, 게임 분류, footer, 이미지 alt, 배지 같은 세부값은 별도 '원본 사이트 관측 정보' 섹션에서 표시할 수 있도록 observation_summary에만 정리합니다.",
  ...
  "'관측되었습니다'는 최대 2회까지만 사용하고, '공개 화면', '공개 HTML', '조회 시점 기준' 표현도 반복하지 않습니다.",
  "'구성 요소', '문구가 확인되었습니다', '배치된 형태로 보입니다'처럼 AI 리포트처럼 보이는 표현은 최소화합니다.",
  "대신 '확인됩니다', '표시됩니다', '사용되었습니다', '구성되어 있습니다', '함께 보입니다', '따로 정리했습니다'처럼 자연스러운 표현을 사용합니다.",
...
- 첫 문단에는 다음 고지를 짧게 넣습니다: "이 설명은 조회 시점 기준 관리자가 제공한 공개 HTML과 스크린샷을 바탕으로 작성되었습니다. 화면에 표시된 정보만 요약한 것이며, 가입이나 이용을 권유하는 내용은 아닙니다."
- detail_description_md는 3~4문단으로 제한하고, 각 문단은 2~3문장 이내로 작성합니다.
- 전체 분량은 400~700자 정도를 우선합니다.
...
- 세부 메뉴, 게임 분류, footer, 이미지 alt, 배지 같은 값은 detail_description_md에 나열하지 말고 별도 "원본 사이트 관측 정보" 섹션에서 표시할 수 있도록 observation_summary 배열에만 정리합니다.
- 메뉴 전체 목록, 게임명, 카테고리명, 언어명, footer 문구를 길게 나열하지 않습니다.
- "관측되었습니다"는 최대 2회까지만 사용하고, "공개 화면", "공개 HTML", "조회 시점 기준" 표현도 반복하지 않습니다.
- "구성 요소", "문구가 확인되었습니다", "배치된 형태로 보입니다"처럼 AI 리포트처럼 보이는 표현은 최소화합니다.
- 대체 표현으로 "확인됩니다", "표시됩니다", "사용되었습니다", "구성되어 있습니다", "함께 보입니다", "따로 정리했습니다"를 우선 사용합니다.
