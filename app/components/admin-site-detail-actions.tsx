...
function formatIndexabilityItem(value: string) {
  ...
  const labels: Record<string, string> = {
    ...
    operating_history: "운영 이력",
    public_supabase_source: "공개 Supabase 데이터",
    representative_domain: "대표 도메인",
    representative_domain_missing: "대표 도메인 없음",
    related_blog_report: "관련 블로그 리포트",
    screenshot: "스크린샷",
    site: "사이트 정보",
    site_name: "사이트명",
    site_name_missing: "사이트명 없음",
    site_missing: "사이트 정보 없음",
    site_not_public: "승인 공개 상태 아님",
    trust_score_data: "신뢰 점수 구성 데이터",
    valid_slug: "정상 slug",
    whois_info: "WHOIS 정보",
  };
