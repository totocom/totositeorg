...
export const homeFaqItems: SiteFaqItem[] = [
  ...
  {
    question: "먹튀 피해 신호는 어떤 기준으로 확인하나요?",
    answer:
      "출금 지연 또는 거부, 고객센터 연락 두절, 불명확한 보너스 약관, 도메인 잦은 변경, 라이선스 정보 미공개는 주의해서 볼 수 있는 신호입니다. 단일 항목만으로 사이트 상태를 단정하지 말고, 공개 제보와 이용자 후기를 함께 확인하는 것이 좋습니다.",
  },
  {
